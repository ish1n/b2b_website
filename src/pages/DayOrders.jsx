...
export default function DayOrders() {
    ...
    const monthOrders = useMemo(() =>
        orders.filter(o => o.month === monthNum),
        [orders, monthNum]
    );
    ...
    const dayOrders = useMemo(() =>
        selectedDay !== null ? monthOrders.filter(o => o.day === selectedDay) : [],
        [monthOrders, selectedDay]
    );
    ...
    return (
        <div className="min-h-screen bg-[#F0F7FF]" style={{ fontFamily: 'Poppins, sans-serif' }}>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <PageHeader
                    title={`${MONTH_NAMES[monthNum] || `Month ${month}`} — Day-wise Orders`}
                ...
                <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                    ...
                    {!selectedDay ? (
                        ...
                        <>
                            ...
                            <OrderTable orders={dayOrders} showTenant={true} />
                        </>
                    )}
                </div>
            </div>
